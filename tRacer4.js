        ...
        if (endGame === false) {                                                    // Game is over prevent code from running
            ...
            if (e.keyCode > 64 || e.keyCode === 8 || e.keyCode === 32) {            // Prevent Shift caps lock and other characters from giving false negative
                ...
                //Game logic--(Wrong Inputs) ---------
                    ...
                    if (e.keyCode !== 8 && String.fromCharCode(e.keyCode) != arrPhrase[curLetter] && x.length > curLetter) {                                          // User's input isn't delete.
                    ...
                    else {                                    // Needs work fix for deletion of correct letter *****************************
                        if (x.length > 0)
                        {
                ...
                console.log("current word Count " + curWord)
            }
        }
    }
